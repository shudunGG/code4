...
public class LoginController
{
    ...
    throws Exception
  {
    ...
    if (member != null)
    {
      ...
      else if ("zxyy".equals(zxtsaction))
      {
    	String unid =  (String)session.getAttribute("unid");
    	String zxyyport =  (String)session.getAttribute("zxyyport");
    	String zxyyservicename =  (String)session.getAttribute("zxyyservicename");
    	String zxyywebid =  (String)session.getAttribute("zxyywebid");
        message ="http://"+zxyyservicename+":"+zxyyport+ zxyyproperties.getString("zxyyurl")+"?webid="+zxyywebid+"&unid="+unid;
      }
    }
