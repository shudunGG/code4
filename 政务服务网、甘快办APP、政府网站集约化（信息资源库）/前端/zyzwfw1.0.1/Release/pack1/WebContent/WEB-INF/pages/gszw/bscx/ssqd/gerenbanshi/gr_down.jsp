	...
	$.ajax({
	  ...
	  success: function(tiaozhuanAddr){
		  if("needlogin"==tiaozhuanAddr){
			  ...
			  }else if("gaishixiangfarenbunengbanli" == tiaozhuanAddr){
				alert('该事项法人不能办理');
				}else{
...
function gopage(number){
	...
	var gerenthemeId = document.getElementById("gerenthemeId").innerText;
 ...
 * @return
 */
function grzxts(webid,type, itemcode, orgcode,centercode,itemname) {
	var hostName = window.location.host;
		...
		<li class="child_1">
			...
			<c:if test="${fn:length(shishiqingdan.taskname)>29}">
				...
				<c:if test="${shishiqingdan.linkAddr != ''}">
           			...
           			'${shishiqingdan.linkAddr}','tysb','1','${shishiqingdan.i_webid}','${shishiqingdan.taskname}');">在线办理</a>
          			</c:if>
			...
			<div class="childItem">
				...
				<a class="bak5" onclick="grzxts('${shishiqingdan.i_webid}','0','','','001002003002','${shishiqingdan.taskname}')">我要咨询</a>
				<c:if test="${not empty shishiqingdan.rowGuid}">
				<a class="bak5" onclick=
               			"panduanshifoudengluAndTiaozhuan('${shishiqingdan.taskCode}','${shishiqingdan.rowGuid}',
	           			'/gszw/zxyy/index.do?webid=${webid}&unid=${shishiqingdan.rowGuid}',
	           			'tysb',
	           			'1','${shishiqingdan.i_webid}','${shishiqingdan.taskname}');"  target="_blank">我要预约</a>								
				</c:if>
			...
			<li>
				...
				<div class="childHtem">
					...
					<div class="childHtem2">
						...
						<a class="ico" onclick="grzxts('${shishiqingdan.i_webid}','0','','','001002003002','${yewubanlixiang.taskname}')">我要咨询</a>
						...
						<c:if test="${not empty yewubanlixiang.rowGuid}">
				         <a class="ico" onclick=
	           			...
	           			'tysb',
	           			'1','${shishiqingdan.i_webid}','${yewubanlixiang.taskname}');"  target="_blank">我要预约</a>								
				</c:if>
					</div>																		
				</div>
			</li>
