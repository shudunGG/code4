      ...
      <div class="concent">
        ...
        <div class="concent_info">
          ...
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>终止劳动关系类型：</div>
            <van-field
              maxlength="30"
              v-model="zzldgxlx"
          ...
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>终止劳动合同文件号：</div>
            <van-field
              maxlength="30"
              v-model="basicInfomation.zzldhtwjh"
              placeholder="请填写终止劳动合同文件号"
            />
          </div>
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>发文单位：</div>
            <van-field
              maxlength="30"
