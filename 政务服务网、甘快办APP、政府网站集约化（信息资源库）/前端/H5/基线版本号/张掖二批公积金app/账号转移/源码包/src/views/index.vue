      ...
      <div class="concent">
        ...
        <div class="concent_info">
          ...
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>转出单位名称：</div>
            <van-field
              maxlength="30"
              v-model="basicInfo.zcdwmc"
              placeholder="请填写转出单位名称"
            />
          </div>
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>转入单位名称：</div>
            <van-field
              maxlength="30"
              v-model="basicInfo.zrdwmc"
              placeholder="请填写转入单位名称"
            />
          </div>
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>证件号码：</div>
            <van-field
              maxlength="30"
          ...
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>姓名：</div>
            <van-field
              maxlength="30"
              v-model="basicInfo.xingming"
              placeholder="请填写姓名"
            />
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    keyUp() {
      ...
      const pattern =
        /[`~!@#$^&*()=|{}':;',\\[\]<>/?~！@#￥……&%*（）——|{}【】'；：""'。，、？\s]/g;
      this.basicInfo.zcdwmc = this.basicInfo.zcdwmc.replace(pattern, "");
      this.basicInfo.zrdwmc = this.basicInfo.zrdwmc.replace(pattern, "");
      this.basicInfo.zjhm = this.basicInfo.zjhm.replace(pattern, "");
      this.basicInfo.xingming = this.basicInfo.xingming.replace(pattern, "");
    },
    // 验证收款人名称是否为汉字
    // validate() {
    //   const pattern = /^[\u4e00-\u9fa5]+$/;
    ...
    queryList() {
      // this.keyUp()
      if (this.basicInfo.zcdwmc === "") {
        Toast("请填写转出单位名称");
        return;
      }
      if (this.basicInfo.zrdwmc === "") {
        Toast("请填写转入单位名称");
        return;
      }
      ...
      if (!sfz.test(this.basicInfo.zjhm)) {
        Toast("请输入正确的身份证号码");
        return;
      }
      if (this.basicInfo.xingming === "") {
        Toast("请填写姓名");
        return;
      }
