      ...
      <div class="concent">
        ...
        <div class="concent_info">
          ...
          <div class="concent_info_picker" @click="showPickerRoomType = true">
            <div class="picker_t"><span>*</span>修建类型：</div>
            <van-field
              maxlength="30"
              v-model="tqyyxq"
              placeholder="请选择修建类型"
          ...
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>计划建造费用（元）：</div>
            <van-field
              maxlength="30"
              v-model="basicInfomation.jhjzfy"
              placeholder="请填写计划建造费用"
              type="number"
            />
          </div>
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>房屋总价（元）：</div>
            <van-field
              maxlength="30"
          ...
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>修建部位：</div>
            <van-field
              maxlength="30"
              v-model="basicInfomation.xjbw"
              placeholder="请填写修建部位"
            />
          </div>
          <div class="concent_info_picker">
...
export default {
  ...
  methods: {
    ...
    keyUp() {
      ...
      const pattern =
        /[`~!@#$^&*()=|{}':;',\\[\]<>/?~！@#￥……&%*（）——|{}【】'；：""'。，、？\s]/g;
      this.basicInfomation.tqyyxq = this.basicInfomation.tqyyxq.replace(
        pattern,
        ""
      );
      ...
      this.basicInfomation.jhjzfy = this.basicInfomation.jhjzfy.replace(
        pattern,
        ""
      );
      ...
      this.basicInfomation.xjbw = this.basicInfomation.xjbw.replace(
        pattern,
        ""
      );
      ...
      this.basicInfomation.jhkgrq = this.basicInfomation.jhkgrq.replace(
        pattern,
        ""
      );
      this.basicInfomation.jhjgrq = this.basicInfomation.jhjgrq.replace(
        pattern,
        ""
      );
    ...
    confirm({ text, value }) {
      ...
      this.tqyyxq = text;
      this.basicInfomation.tqyyxq = value;
    ...
    queryList() {
      ...
      if (this.basicInfomation.jhjzfy === "") {
        Toast("请填写计划建造费用");
        return;
      }
      ...
      if (this.basicInfomation.jhkgrq === "") {
        Toast("请选择计划开工日期");
        return;
      }
      if (this.basicInfomation.jhjgrq === "") {
        Toast("请选择计划竣工日期");
        return;
      }
      if(this.endTime < this.startTime){
        Toast("计划竣工日期不能小于计划开工日期");
        return;
      }
