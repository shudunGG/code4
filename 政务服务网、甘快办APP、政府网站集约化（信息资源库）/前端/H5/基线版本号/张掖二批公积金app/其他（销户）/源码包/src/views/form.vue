      ...
      <div class="concent">
        ...
        <div class="concent_info">
          ...
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>提取原因详情：</div>
            <van-field
              maxlength="30"
              v-model="basicInfomation.tqyyxq"
              placeholder="请填写提取原因详情"
            />
          </div>
          <div class="concent_info_picker">
            <div class="picker_t"><span>*</span>备注：</div>
            <van-field
              maxlength="30"
              v-model="bz"
              placeholder="请填写备注"
...
export default {
  ...
  methods: {
    ...
    keyUp() {
      ...
      this.basicInfomation.tqyyxq = this.basicInfomation.tqyyxq.replace(pattern,"");
    ...
    queryList() {
      // this.keyUp()
      if (this.basicInfomation.tqyyxq === '') {
        Toast('请填写提取原因详情')
        return
      }
