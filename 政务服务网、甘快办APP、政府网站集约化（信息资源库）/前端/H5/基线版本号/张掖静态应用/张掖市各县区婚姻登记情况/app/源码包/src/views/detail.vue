      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">区县名称</div>
              <div class="list-right">{{ item.diqu || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">区县结婚登记人数</div>
              <div class="list-right">{{ item.jiehun || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">区县离婚登记人数</div>
              <div class="list-right">{{ item.lihun || '暂无数据' }}</div>
            </div>
          </div>
        </div>
      </van-list>
