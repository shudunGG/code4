      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">级别</div>
              <div class="list-right">{{ item.jb || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">计划示范村</div>
              <div class="list-right">{{ item.jhsfc || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">建成完成示范村</div>
              <div class="list-right">{{ item.jcwcsfc || '暂无数据' }}</div>
            </div>
          </div>
        </div>
      </van-list>
