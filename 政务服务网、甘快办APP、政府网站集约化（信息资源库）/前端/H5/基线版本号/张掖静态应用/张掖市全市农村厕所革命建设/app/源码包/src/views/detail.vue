      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">累计建设数量</div>
              <div class="list-right">{{ item.leiji || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">本年已建设数量</div>
              <div class="list-right">{{ item.yijianshe || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">本年任务完成率</div>
              <div class="list-right">{{ item.wanchenglv ? item.wanchenglv * 100 + '％' : '暂无数据' }}</div>
            </div>
          </div>
        </div>
      </van-list>
