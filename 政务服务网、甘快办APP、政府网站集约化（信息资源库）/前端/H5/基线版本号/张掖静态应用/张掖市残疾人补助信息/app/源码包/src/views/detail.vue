      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">相关部门</div>
              <div class="list-right">{{ item.bumen || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">全市残疾人人数</div>
              <div class="list-right">{{ item.renshu || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">全市残疾人补贴总额</div>
              <div class="list-right">{{ item.zonge || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">上年度全市残疾人补贴总额</div>
              <div class="list-right">{{ item.shangjiduzonge || '暂无数据' }}</div>
            </div>
          </div>
        </div>
      </van-list>
