    ...
    <div class="result">
      <template>
        <table v-for="(item, index) in resultsObj.dataList" :key="index">
          ...
          <tr>
            <td class="tab_bt">全市孤儿数量</td>
            <td>{{ item.shuliang || "暂无数据" }}</td>
            <td class="tab_bt">分散供养人数</td>
            <td>{{ item.fensan || "暂无数据" }}</td>
          </tr>
          <tr>
            <td class="tab_bt">集中供养人数</td>
            <td>{{ item.jizhong || "暂无数据" }}</td>
            <td class="tab_bt">全市孤儿基本生活费发放总额</td>
            <td>{{ item.jine || "暂无数据" }}</td>
          </tr>
        </table>
        <div class="block">
          <el-pagination
