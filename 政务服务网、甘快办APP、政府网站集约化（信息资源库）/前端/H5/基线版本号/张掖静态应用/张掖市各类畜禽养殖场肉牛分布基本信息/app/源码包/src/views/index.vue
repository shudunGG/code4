<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">区县</div>
...
export default {
  ...
  methods: {
    ...
    queryList() {
      ...
      if (/[\s]/g.test(this.quxian)) {
        this.quxian = this.quxian.replace(/\s+/g, '');
      }
      Toast({
        message: '加载中...',
        duration: 0,
        ...
        res => {
          ...
          if (res.dataList && res.dataList.length > 0) {
            ...
            this.$router.push({
              path: '/listDetail',
              query: {
                quxian: JSON.stringify(this.quxian),
              },
            });
          } else {
            Toast({
