      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">低保对象总人数</div>
              <div class="list-right">{{ item.zongrenshu || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">城市低保对象人数</div>
              <div class="list-right">{{ item.chengshi || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">农村低保对象人数</div>
              <div class="list-right">{{ item.nongcun || '暂无数据' }}</div>
            </div>
          </div>
        </div>
      </van-list>
