      ...
      <template>
        <table v-for="(item, index) in resultsObj.dataList" :key="index">
          <tr>
            ...
            <td class="tab_bt">地区</td>
            <td>{{ item.diqu || "暂无数据" }}</td>
          </tr>
          <tr>
            <td class="tab_bt">殡葬服务中心个数</td>
            <td>{{ item.geshu || "暂无数据" }}</td>
            <td class="tab_bt">公益性骨灰堂个数</td>
            <td>{{ item.guihuitang || "暂无数据" }}</td>
          </tr>
          <tr>
            <td class="tab_bt">困难家庭帮助数量</td>
            <td>{{ item.kunnan || "暂无数据" }}</td>
            <td class="tab_bt">减免基本殡葬费用总额</td>
