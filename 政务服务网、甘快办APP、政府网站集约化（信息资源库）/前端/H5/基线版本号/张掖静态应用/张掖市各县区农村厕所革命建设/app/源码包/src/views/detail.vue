      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">计划建设数量</div>
              <div class="list-right">{{ item.jihua || '暂无数据' }}</div>
            </div>
            <div class="list">
              <div class="list-left">实际建设数量</div>
              <div class="list-right">{{ item.shiji || '暂无数据' }}</div>
            </div>
          </div>
        </div>
      </van-list>
