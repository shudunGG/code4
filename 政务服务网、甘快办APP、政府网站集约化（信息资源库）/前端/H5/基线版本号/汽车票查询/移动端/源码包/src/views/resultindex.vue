        ...
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            <div class="list">
              ...
              <div class="list-right">{{ item.jgmc || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">联系电话</div>
              <div class="list-right"><a style="color: #1677ff;" :href="'tel:' + item.phone">{{ item.phone || "暂无数据" }}</a></div>
            </div>
            <div class="list">
              <div class="list-left">地址</div>
              <div class="list-right">{{ item.address || "暂无数据" }}</div>
            </div>
          </div>
        </div>
      </van-list>
    </div>
    <div class="message">本服务由甘肃省武威市提供</div>
  </div>
</template>
