<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">基层社名称</div>
        <input v-model="code" @keyup="keyUp" placeholder="请输入基层社名称" type="text" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        let res = await IndexApi.queryList(params, '531f873d9ba2404e9ffebfcbb292d665')
        Toast.clear()
