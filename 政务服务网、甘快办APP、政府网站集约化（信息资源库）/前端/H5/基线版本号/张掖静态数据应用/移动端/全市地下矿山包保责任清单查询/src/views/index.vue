<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">矿山名称</div>
        <input v-model="code" @keyup="keyUp" placeholder="请输入矿山名称" type="text" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        let res = await IndexApi.queryList(params, 'b7f4b972fd2b4847b449d2ff491d6fb9')
        Toast.clear()
