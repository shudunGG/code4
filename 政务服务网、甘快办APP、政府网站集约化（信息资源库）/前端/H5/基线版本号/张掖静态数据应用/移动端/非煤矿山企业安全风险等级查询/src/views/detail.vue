      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            <table>
              <tr>
                <td colspan="4">张掖市非煤矿山企业安全风险等级查询</td>
              </tr>
              <tr>
                <td class="tab_bt">矿山企业名称</td>
                <td>{{ item.mc || '暂无数据' }}</td>
              </tr>
              <tr>
                <td class="tab_bt">所在县区</td>
                <td>{{ item.xq || '暂无数据' }}</td>
              </tr>
              <tr>
                <td class="tab_bt">安全风险等级</td>
                <td>{{ item.dj || '暂无数据' }}</td>
              </tr>
              <tr>
...
export default {
  ...
  methods: {
    ...
    queryList(value) {
      ...
      IndexApi.queryList(params,'ac3d34f8cb2b409a922946d292a9e455')
        .then(res => {
