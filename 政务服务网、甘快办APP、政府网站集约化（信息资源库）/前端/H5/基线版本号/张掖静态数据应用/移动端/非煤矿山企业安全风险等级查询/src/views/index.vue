<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">矿山企业名称</div>
        <input v-model="code" @keyup="keyUp" placeholder="请输入矿山企业名称" type="text" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        let res = await IndexApi.queryList(params, 'ac3d34f8cb2b409a922946d292a9e455')
        Toast.clear()
    ...
    onConfirm(text, index) {
      ...
      if (typeof text === 'string') {
        this.selectName = text.label
        this.selectArr = text.value
      } else {
        this.selectName = text.label
        this.selectArr = text.value
      }
