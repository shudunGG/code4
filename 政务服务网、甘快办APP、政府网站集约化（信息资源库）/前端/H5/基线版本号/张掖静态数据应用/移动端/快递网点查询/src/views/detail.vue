      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            <table>
              <tr>
                <td colspan="4">张掖市快递网点查询</td>
              </tr>
              <tr>
                <td class="tab_bt">企业名称</td>
                <td>{{ item.qy || '暂无数据' }}</td>
              </tr>
              <tr>
                <td class="tab_bt">分支机构名称</td>
                <td>{{ item.jg || '暂无数据' }}</td>
              </tr>
              <tr>
                <td class="tab_bt">企业地址</td>
                <td>{{ item.dz || '暂无数据' }}</td>
              </tr>
              <tr>
                <td class="tab_bt">企业负责人</td>
                <td>{{ item.fzr || '暂无数据' }}</td>
              </tr>
              <tr>
...
export default {
  ...
  methods: {
    ...
    queryList(value) {
      ...
      IndexApi.queryList(params,'0425bd31e9ba4e9bad655fa1de433744')
        .then(res => {
