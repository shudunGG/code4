<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">企业名称</div>
        <input v-model="code" @keyup="keyUp" placeholder="请输入企业名称" type="text" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        let res = await IndexApi.queryList(params, '0425bd31e9ba4e9bad655fa1de433744')
        Toast.clear()
