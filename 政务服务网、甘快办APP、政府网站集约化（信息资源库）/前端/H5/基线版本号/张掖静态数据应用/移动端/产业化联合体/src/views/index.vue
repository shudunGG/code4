<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">项目名称</div>
        <input v-model="code" @keyup="keyUp" placeholder="请输入项目名称" type="text" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        let res = await IndexApi.queryList(params, '8a654d4dfd084f3a85714a5620cce636')
        Toast.clear()
