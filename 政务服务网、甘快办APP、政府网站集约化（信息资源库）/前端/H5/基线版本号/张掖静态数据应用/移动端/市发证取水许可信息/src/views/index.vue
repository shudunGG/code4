<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">取水权人名称</div>
        <input v-model="code" @keyup="keyUp" placeholder="请输入取水权人名称" type="text" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        let res = await IndexApi.queryList(params, '3cfad260831347b79f3550e2b05daf81')
        Toast.clear()
