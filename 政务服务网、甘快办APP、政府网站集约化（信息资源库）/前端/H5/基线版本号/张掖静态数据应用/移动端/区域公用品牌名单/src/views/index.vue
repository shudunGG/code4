<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin-top: 110px">
      ...
      <div class="card-list">
        <div class="card-list-title">品牌名称</div>
        <input v-model="code" @keyup="keyUp" placeholder="请输入品牌名称" type="text" />
      </div>
...
export default {
  ...
  methods: {
    ...
    async queryList() {
      ...
      try {
        let res = await IndexApi.queryList(params, '4e530e2477b845218a2cfd7d81a81c15')
        Toast.clear()
