      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item,index) in list" :key="index">
            <div class="list">
            <div class="list-left">单位名称</div>
            <div class="list-right">{{ item.mingcheng || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">单位性质</div>
            <div class="list-right">{{ item.xingzhi || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">单位地址</div>
            <div class="list-right">{{ item.dizhi || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">咨询电话</div>
            <div class="list-right">{{ item.dianhua || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">是否免费开放</div>
            <div class="list-right">{{ item.mianfei || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">开放时间</div>
            <div class="list-right">{{ item.shijian || '暂无数据' }}</div>
          </div>
        </div>
      </div>
      </van-list>
