      ...
      >
        <div class="container-bottom">
          ...
          <div class="list">
            ...
            <div class="list-right">{{ item.xingbie || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">民族</div>
            <div class="list-right">{{ item.minzu || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">有效范围</div>
            <div class="list-right">{{ item.youxiaofanwei || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">职称等级</div>
            <div class="list-right">{{ item.zhichengdengji || '暂无数据' }}</div>
          </div>
