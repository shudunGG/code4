...
const tools = {
  // sm4加密
  SM4: function (text) {
    let sm4 = new JSSM4('g@Edevf%3g@B*xeT')
    return sm4.encryptData_ECB(text)
  },

  // sm4解密
  sm4Decrypt: function (text) {
  ...
  RSAdecryption: function (str) {
    // 注册方法
    let pubKey = `MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCbrpLs/OcH7X0J51DEP1ScVHTgiQQQFKoVVaejVJ8IH/Smnzaj4YikjkPM9SdvqbgVB+wq93YJYREqhTLvQZuiC4MwxlTu8EvSwi5yZXVJE7wVXTeRIWteFMR09o3HISY2KJXJqFhwezMj7H9c6+XjuaWsX4JGRdebKA8NUh/LZwIDAQAB` // ES6 模板字符串 引用 rsa 私钥
