      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item,index) in list" :key="index">
            <div class="list">
            <div class="list-left">社会组织名称</div>
            <div class="list-right">{{ item.name || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">法定代表人姓名</div>
            <div class="list-right">{{ item.faren || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">住所的详细地址</div>
            <div class="list-right">{{ item.dizhi || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">业务范围</div>
            <div class="list-right">{{ item.yewufanwei || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">联系人</div>
            <div class="list-right">{{ item.lianxiren || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">联系电话</div>
            <div class="list-right" :style="item.lianxidianhua==''?'': 'color:blue;'" @click="callPhone(item.lianxidianhua)">{{ item.lianxidianhua || '暂无数据' }}</div>
          </div>
