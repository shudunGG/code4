      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item,index) in list" :key="index">
            <div class="list">
            <div class="list-left">学段</div>
            <div class="list-right">{{ item.xueduan || '暂无数据' }}</div>
          </div>
          <div class="list">
          ...
          <div class="list">
            <div class="list-left">学校位置</div>
            <div class="list-right">{{ item.weizhi || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">学校简介</div>
            <div class="list-right">{{ item.jianjie || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">负责人</div>
            <div class="list-right">{{ item.fuzeren || '暂无数据' }}</div>
          </div>
          <div class="list">
           ...
           <div class="list">
            <div class="list-left">招生区域</div>
            <div class="list-right">{{ item.zhaoshengquyu || '暂无数据' }}</div>
          </div>
