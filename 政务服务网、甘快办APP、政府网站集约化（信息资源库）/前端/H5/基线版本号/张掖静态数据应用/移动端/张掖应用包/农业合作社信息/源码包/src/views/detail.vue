      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item,index) in list" :key="index">
            ...
            <div class="list-right">{{ item.mingcheng || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">行业代码</div>
            <div class="list-right">{{ item.hangyedaima || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">经营场所</div>
            <div class="list-right">{{ item.jingyingchangsuo || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">经营者姓名</div>
            <div class="list-right">{{ item.xingming || '暂无数据' }}</div>
          </div>
          <div class="list">
            <div class="list-left">联系电话</div>
            <div class="list-right" :style="item.lianxifangshi==''?'': 'color:blue;'" @click="callPhone(item.lianxifangshi)">{{ item.lianxifangshi || '暂无数据' }}</div>
          </div>
