          ...
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            <table>
              ...
              <tr>
                ...
                <td style="white-space:pre-line">{{ item.wz || '暂无数据' }}</td>
              </tr>
              <tr>
                <td class="tab_bt">简介</td>
                <td style="white-space:pre-line;">{{ item.jj || '暂无数据' }}</td>
              </tr>
              <tr>
...
export default {
  ...
  methods: {
    ...
    queryList(value) {
      ...
      IndexApi.queryList(params, '28084767d5fe4492aabb99a6f1b860c8')
        .then(res => {
