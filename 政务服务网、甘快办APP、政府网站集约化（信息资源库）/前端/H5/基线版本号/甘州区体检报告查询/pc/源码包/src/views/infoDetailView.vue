    ...
    <div class="content_from">
      <div class="card">
        <div class="card_text">
          ...
          <div>
            检测日期：<span>{{ info.MAINCHECKTIME || "/" }}</span>
          </div>
          <div>
        ...
        <div class="card_text">
          ...
          > -->
          <div>
            初检登记id：<span>{{ info.FIRSTREGID || "/" }}</span>
          </div>
          <!-- </el-tooltip> -->
          <!-- <div>
      ...
      <div class="table-responsive">
        <div v-html="info.RESULTSUMMARY"></div>
        <!-- <el-table
          :data="tableData"
          style="width: 100%"
      ...
      serveAPI
        ...
        .then((res) => {
          ...
          if (
            ...
            console.log(result, "甘州区医院报告详情查询");
