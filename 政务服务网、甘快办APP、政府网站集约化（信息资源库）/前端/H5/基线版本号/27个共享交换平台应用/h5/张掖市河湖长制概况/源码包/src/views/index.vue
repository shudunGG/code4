      ...
      <div class="card">
        <div class="box2">
          ...
          <div class="box2_right">
            <div>流域面积1000平方公里以上河道数量</div>
            <div class="box2_child">
              <div>{{ info.lymj50ys ? info.lymj50ys + '条' : '--' }}</div>
            </div>
          </div>
        </div>
        <div class="box3">
          ...
          <div class="box3_right">
            <div>流域面积1000平方公里以下河道数量</div>
            <div class="box3_child">
              <div>{{ info.lymj50yx ? info.lymj50yx + '条' : '--' }}</div>
            </div>
          </div>
        </div>
        <div class="box1">
          <div class="box1_left">
            <div class="tag"></div>
            <div>河长人数</div>
            <div>{{ info.hezrs ? info.hezrs + '人' : '--' }}</div>
          </div>
          <div class="box1_right">
            <div class="tag"></div>
            <div>湖长人数</div>
            <div>{{ info.huzrs ? info.huzrs + '人' : '--' }}</div>
          </div>
        </div>
...
const getData = () => {
  const param = {
    params: sm2.sm2Encrypt(JSON.stringify({
      normGuid: "8488b474-f7fa-453d-ae13-5959d1a28b29",
      fieldList: []
    })),
  };
