...
export default {
  ...
  idcardDesensitization: function (
    ...
    if (name.length === 2) {
      ...
      name = name.replace(name.substr(0, name.length - 2), '***')
    ...
    return {
      userName: name,
      mobile: phoneStr.substring(0, 3) + '******' + phoneStr.substring(9, 11),
      idCard: star + cardStr.substring(17, 18),
