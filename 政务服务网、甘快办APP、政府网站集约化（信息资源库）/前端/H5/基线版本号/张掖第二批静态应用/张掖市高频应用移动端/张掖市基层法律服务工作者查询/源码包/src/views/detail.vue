        ...
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              ...
              <div class="list-right">{{ item.fzrxm || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">联系电话</div>
              <div class="list-right" @click="tel(item.lxdh)">{{ item.lxdh || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">备注</div>
              <div class="list-right">{{ item.bz || "暂无数据" }}</div>
            </div>
          </div>
        </div>
      </van-list>
