      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            <div class="list">
              <div class="list-left">所在街道</div>
              <div class="list-right">{{ item.name || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">服务类型</div>
              <div class="list-right">{{ item.fwlx || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">名称</div>
              <div class="list-right">{{ item.mc || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">具体位置</div>
              <div class="list-right">{{ item.jtwz || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">经纬度</div>
              <div class="list-right">{{ item.jwd || "暂无数据" }}</div>
            </div>
          </div>
        </div>
      </van-list>
