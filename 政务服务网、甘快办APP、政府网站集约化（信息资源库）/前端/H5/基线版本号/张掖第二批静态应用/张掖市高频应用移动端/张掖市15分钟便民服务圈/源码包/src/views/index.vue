<template>
  <div class="container-wrap">
    ...
    <div class="card-wrap" style="margin: 110px 16px 0 16px">
      ...
      <div class="card-list">
        <div class="card-list-title">所在街道</div>
...
<!--      <image class="noData-image" src="../../assets/image/noData.png"></image>-->
...
export default {
  ...
  methods: {
    ...
    // 查询
    async queryList () {
      if (/[`~!@#$^&*()=|{}':;',\\\[\]\.<>\/?~！@#￥……&%*（）——|{}【】'；：""'。，、？]/g.test(this.name) || this.name.includes('-')) {
        Toast({
          message: '不能含有特殊字符',
          duration: 1000
        })
