      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">车次</div>
              <div class="list-right">{{ item.cc || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">运营方式</div>
              <div class="list-right">{{ item.yyfs || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">运距</div>
              <div class="list-right">{{ item.yj || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">发车时间</div>
              <div class="list-right">{{ item.fcsj || "暂无数据" }}</div>
            </div>
          </div>
        </div>
      </van-list>
