      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.brandname }}</p>
            <div class="info">
              <span class="infoLeft">产品种类</span>
              <span class="address">{{ item.type }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">公司名称</span>
              <span class="address">{{ item.companyname }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">所属区县</span>
              <span class="address">{{ item.county }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">认定时间</span>
              <span class="address">{{ item.time }}年 </span>
            </div>
            <div class="info">
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "33" }));
