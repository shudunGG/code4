      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.name }}</p>
            <div class="info">
              <span class="infoLeft">社会代码</span>
              <span class="address">{{ item.socialcode }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">许可编号</span>
              <span class="address">{{ item.xukebianhao }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">场所地址</span>
              <span class="address">{{ item.address }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">经营业务</span>
              <span class="address">{{ item.service }} </span>
            </div>
            <div class="info">
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "36" }));
