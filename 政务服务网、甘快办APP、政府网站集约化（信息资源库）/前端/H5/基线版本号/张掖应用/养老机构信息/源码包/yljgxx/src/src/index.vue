      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.groupname }}</p>
            <div class="info">
              <span class="infoLeft">所属行政区划</span>
              <span class="address">{{ item.area ==''?'暂无':item.area }} </span>
            </div>
            <div class="info">
            ...
            <div class="info">
              ...
              <span class="address">{{ item.nature }} </span>
            </div>
            <!-- <div class="info">
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "52" }));
