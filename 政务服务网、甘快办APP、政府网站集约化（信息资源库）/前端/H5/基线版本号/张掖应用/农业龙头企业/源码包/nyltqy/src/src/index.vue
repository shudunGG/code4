      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            ...
            <div class="info">
              <span class="infoLeft">县名称</span>
              <span class="address">{{ item.countyname }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">社会信用代码</span>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "34" }));
