      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.name }}</p>
            <div class="info">
              <span class="infoLeft">导游证号</span>
              <span class="address">{{ item.cardno }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">资格证号</span>
              <span class="address">{{ item.zigeno }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">语种</span>
              <span class="address">{{ item.language }} </span>
            </div>
            <div class="info">
            ...
            <div class="info">
              <span class="infoLeft">所属机构</span>
              <span class="address">{{ item.organization }} </span>
            </div>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "37" }));
