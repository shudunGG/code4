      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.sitearea }}</p>
            <div class="info">
              <span class="infoLeft">站点地址</span>
              <span class="address">{{ item.sitearea }} </span>
            </div>
            <!-- <div class="info">
              <span class="infoLeft">详细住所</span>
              <span class="address">{{ item.address }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">法定人</span>
              <span class="address">{{ item.fdr }} </span>
            </div> -->
            <!-- <div class="info">
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "54" }));
