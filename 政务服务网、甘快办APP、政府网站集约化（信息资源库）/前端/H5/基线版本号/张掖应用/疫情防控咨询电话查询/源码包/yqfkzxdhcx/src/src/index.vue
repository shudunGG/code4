      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.area }}</p>
            <div class="info">
              <span class="infoLeft">联系人</span>
              <span class="address">{{ item.lxr }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">联系人电话</span>
              <span class="address">{{ item.lxrtele }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">客服联系电话</span>
              <span class="address">{{ item.kftele }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">值班联系电话</span>
              <span class="address">{{ item.zbtele }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">传真</span>
              <span class="address">{{ item.fax }} </span>
            </div>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "22" }));
