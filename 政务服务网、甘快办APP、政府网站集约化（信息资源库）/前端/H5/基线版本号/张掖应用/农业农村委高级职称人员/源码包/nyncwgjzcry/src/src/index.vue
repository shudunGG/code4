      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.name }}</p>
            <div class="info">
              <span class="infoLeft">性别</span>
              <span class="address">{{ item.sex }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">工作单位</span>
              <span class="address">{{ item.workunit }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">职称</span>
              <span class="address">{{ item.job }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">擅长技能</span>
              <span class="address">{{ item.skill}} </span>
            </div>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "35" }));
