      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.groupname }}</p>
            <div class="info">
              <span class="infoLeft">机构门牌号</span>
              <span class="address">{{ item.groupno }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">法人机关</span>
              <span class="address">{{ item.farenjiguan }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">类别</span>
              <span class="address">{{ item.type }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">单位性质</span>
              <span class="address">{{ item.nature ==''?'暂无':item.nature}} </span>
            </div>
            <!-- <div class="info">
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "48" }));
