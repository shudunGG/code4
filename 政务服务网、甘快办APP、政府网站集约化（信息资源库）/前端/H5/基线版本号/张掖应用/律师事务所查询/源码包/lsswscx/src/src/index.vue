      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.lawofficename }}</p>
            <div class="info">
              <span class="infoLeft">地址</span>
              <span class="address">{{ item.address }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">电话</span>
              <span class="address">{{ item.tele }} </span>
            </div>
            <!-- <div class="info">
              <span class="infoLeft">人数</span>
              <span class="address">{{ item.rennum }}人 </span>
            </div>
            <div class="info">
              <span class="infoLeft">地区</span>
              <span class="address">{{ item.area | area}} </span>
            </div>
            <div class="info">
              <span class="infoLeft">初级人数</span>
              <span class="address">{{ item.primarynum }}人 </span>
            </div>
            <div class="info">
              <span class="infoLeft">中级人数</span>
              <span class="address">{{ item.middlenum }}人 </span>
            </div>
            <div class="info">
              <span class="infoLeft">党员数目</span>
              <span class="address">{{ item.partynum }}人 </span>
            </div>
            <div class="info">
              <span class="infoLeft" style="width:50%">心理咨询师人数</span>
              <span class="address">{{ item.psychologicalnum }}人 </span>
            </div> -->
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "18" }));
