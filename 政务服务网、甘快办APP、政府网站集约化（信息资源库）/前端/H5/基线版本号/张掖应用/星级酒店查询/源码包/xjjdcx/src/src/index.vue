      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.name }}</p>
            <div class="info">
              <span class="infoLeft">星级</span>
              <span class="address">{{ item.level }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">证书编号</span>
              <span class="address">{{ item.certificateno }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">认定时间</span>
              <span class="address">{{ item.time }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">总机电话</span>
              <span class="address">{{ item.tele }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">客房床位</span>
              <span class="address">{{ item.guestroomnum }}床 </span>
            </div>
            <div class="info">
              <span class="infoLeft">总床位</span>
              <span class="address">{{ item.bednum }}床</span>
            </div>
            <div class="info">
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "39" }));
