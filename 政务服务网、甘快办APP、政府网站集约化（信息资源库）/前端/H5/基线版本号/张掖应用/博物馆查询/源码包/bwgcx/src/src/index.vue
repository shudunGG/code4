      ...
      <div class="list_box show_box">
        <ul>
          <li v-for="(item, index) in List" :key="index">
            <p>{{ item.name }}</p>
            <div class="info">
              <span class="infoLeft">性质</span>
              <span class="address">{{ item.quality }} </span>
            </div>
            <div class="info">
            ...
            <div class="info">
              <span class="infoLeft">等级</span>
              <span class="address">{{ item.level }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">联系电话</span>
              <span class="address">{{ item.tele==''?'暂无':item.tele }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">是否开放</span>
              <span class="address">{{ item.isopen }} </span>
            </div>
            <div class="info">
              <span class="infoLeft">开放时间</span>
              <span class="address">{{ item.opentime }} </span>
            </div>
          </li>
        </ul>
      </div>
...
export default {
  ...
  methods: {
    ...
    search() {
      ...
      formdata.append("biz_content", JSON.stringify({ type: "43" }));
