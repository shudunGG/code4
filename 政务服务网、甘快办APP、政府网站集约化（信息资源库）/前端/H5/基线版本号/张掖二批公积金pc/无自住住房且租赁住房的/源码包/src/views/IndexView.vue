  ...
  <div>
    <section class="query-container">
      ...
      >
        <div class="flex">
          ...
          >
            <el-input
              placeholder="请填写申请人"
              clearable
              v-model.trim="accountInfo.xingmingtm"
              readonly
            >
            </el-input>
          </el-form-item>
        ...
        <!-- <div class="flex">
          <el-form-item label="身份证号" prop="zjhm" style="width: 48%">
            <el-input
              placeholder="请填写身份证号"
              clearable
...
export default {
  ...
  methods: {
    ...
    resetForm() {
      location.href = "https://zwfw.gansu.gov.cn/zhangye/zwcs/zfgjjglzx/index.html"
    },
  },
};
</script>
