    ...
    <section class="query-container">
      ...
      >
        <div class="flex">
          ...
          >
            <el-input
              placeholder="请选择终止劳动关系类型"
              clearable
              v-model.trim="zzldgxlx"
              disabled
            >
            </el-input>
            <!-- <el-select
          ...
          >
            <el-input
              placeholder="请填写终止劳动合同文件号"
              clearable
              v-model.trim="basicInfomation.zzldhtwjh"
            >
            </el-input>
            <!-- <el-select
              style="width: 100%"
              v-model="basicInfomation.fwdw"
              placeholder="请选择终止劳动合同文件号"
            >
              <el-option
        ...
        <div class="flex">
          <el-form-item label="发文单位" prop="fwdw" style="width: 48%">
            <el-input
              placeholder="请填写发文单位"
              clearable
              v-model.trim="basicInfomation.fwdw"
            >
            </el-input>
            <!-- <el-cascader
              ref="cascader"
