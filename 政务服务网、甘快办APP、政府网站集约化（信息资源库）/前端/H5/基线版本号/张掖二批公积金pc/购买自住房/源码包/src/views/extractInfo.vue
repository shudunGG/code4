<template>
  <div>
    <section class="query-container">
      ...
      >
        <div class="flex">
          <el-form-item label="购房地类型" prop="fwdzlx" style="width: 48%">
            <!-- <el-input
            ...
            <el-select
              style="width: 100%"
              v-model="basicInfomation.fwdzlx"
              placeholder="请选择"
            >
              <el-option
          ...
          <el-form-item label="售房单位" prop="sfdw" style="width: 48%">
            <el-input
              placeholder="请填写售房单位"
              clearable
              v-model.trim="basicInfomation.sfdw"
            >
            </el-input>
          </el-form-item>
        </div>
        <div class="flex">
          <el-form-item label="售房联系电话" prop="sflxdh" style="width: 48%">
            <el-input
              placeholder="请填写售房联系电话"
              clearable
              v-model.trim="basicInfomation.sflxdh"
            >
            </el-input>
          </el-form-item>
          <el-form-item label="房屋地址" prop="fwdz" style="width: 48%">
            <el-input
              placeholder="请填写房屋地址"
              clearable
        ...
        <div class="flex">
          <el-form-item label="购房合同编号" prop="gfhthxyh" style="width: 48%">
            <el-input
              placeholder="请填写购房合同编号"
              clearable
              v-model.trim="basicInfomation.gfhthxyh"
            >
            </el-input>
          </el-form-item>
          <el-form-item label="房屋现状" prop="fwxz" style="width: 48%">
            <!-- <el-input
              placeholder="请填写房屋现状"
              clearable
              v-model.trim="basicInfomation.fwxz"
            >
            </el-input> -->
            <el-select
              style="width: 100%"
        ...
        <div class="flex">
          ...
          <!-- <el-form-item label="房源地址" prop="FYDZ" style="width: 48%">
            <el-input
              ...
              clearable
              v-model.trim="basicInfomation.FYDZ"
            >
            </el-input>
          </el-form-item> -->
        </div>
        <div class="flex">
          <el-form-item label="购房总价" prop="fwzj" style="width: 48%">
            <el-input
              placeholder="请填写购房总价"
              clearable
              v-model.trim="basicInfomation.fwzj"
            >
            </el-input>
          </el-form-item>
          <el-form-item label="不动产证号" prop="bdczh" style="width: 48%">
            <el-input
              placeholder="请填写不动产证号"
              clearable
              v-model.trim="basicInfomation.bdczh"
            >
            </el-input>
          </el-form-item>
          <!-- <el-form-item label="房源地址" prop="FYDZ" style="width: 48%">
        ...
        <div class="flex">
          <el-form-item label="购房时间" prop="gfsj" style="width: 48%">
            <!-- <el-input
              placeholder="请填写购房时间"
              clearable
              v-model.trim="basicInfomation.gfsj"
            >
            </el-input> -->
            <el-date-picker
