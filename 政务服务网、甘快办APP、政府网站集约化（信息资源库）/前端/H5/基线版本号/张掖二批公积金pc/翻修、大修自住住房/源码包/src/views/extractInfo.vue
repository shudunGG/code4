<template>
  <div>
    <section class="query-container">
      ...
      >
        <div class="flex">
          <el-form-item label="修建类型" prop="tqyyxq" style="width: 48%">
            <!-- <el-input
        ...
        <div class="flex">
          <el-form-item label="计划建造费用" prop="jhjzfy" style="width: 48%">
            <el-input
              placeholder="请填写计划建造费用"
              clearable
              v-model.trim="basicInfomation.jhjzfy"
            >
            </el-input>
          </el-form-item>
          <el-form-item label="房屋总价" prop="fwzj" style="width: 48%">
            <el-input
              placeholder="请填写房屋总价"
              clearable
        ...
        <div class="flex">
          <el-form-item label="修建部位" prop="xjbw" style="width: 48%">
            <el-input
              placeholder="请填写修建部位"
              clearable
              v-model.trim="basicInfomation.xjbw"
            >
            </el-input>
          </el-form-item>
