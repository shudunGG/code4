<template>
  <div>
    <section class="query-container">
      ...
      >
        <div class="flex">
          <el-form-item label="转出单位名称" prop="zcdwmc" style="width: 48%">
            <el-input
              placeholder="请填写转出单位名称"
              clearable
              v-model.trim="basicInfo.zcdwmc"
            >
            </el-input>
          </el-form-item>
          <el-form-item label="转入单位名称" prop="zrdwmc" style="width: 48%">
            <el-input
              placeholder="请填写转入单位名称"
              clearable
              v-model.trim="basicInfo.zrdwmc"
            >
            </el-input>
          </el-form-item>
        </div>
        <div class="flex">
          <el-form-item label="证件号码" prop="zjhm" style="width: 48%">
            <el-input
              placeholder="请填写证件号码"
              clearable
              v-model.trim="basicInfo.zjhm"
            >
            </el-input>
          </el-form-item>
          <el-form-item label="姓名" prop="xingming" style="width: 48%">
            <el-input
              placeholder="请填写姓名"
              clearable
              v-model.trim="basicInfo.xingming"
            >
            </el-input>
          </el-form-item>
        </div>
    ...
    return {
      ...
      formRules: {
        ...
        zjhm: [
          ...
          { required: true, validator: validateInputhz, trigger: "blur" },
        ],
        xingming: [
          {
            required: true,
