<template>
  <div>
    <section class="query-container">
      ...
      >
        <div class="flex">
          <el-form-item label="退休类型" prop="ltxlx" style="width: 48%">
            <!-- <el-input
              placeholder="请填写退休类型"
              clearable
              v-model.trim="basicInfomation.ltxlx"
            >
            </el-input> -->
            <el-select
              style="width: 100%"
              v-model="basicInfomation.ltxlx"
              placeholder="请选择"
            >
              <el-option
                v-for="item in ltxlxOptions"
                :key="item.value"
                :label="item.label"
                :value="item.value"
                placeholder="请选择退休类型"
          ...
          <el-form-item label="退休批文文号" prop="txpwwh" style="width: 48%">
            <el-input
              placeholder="请填写退休批文文号"
              clearable
              v-model.trim="basicInfomation.txpwwh"
            >
            </el-input>
          </el-form-item>
        </div>
        <div class="flex">
          <el-form-item label="退休批准单位" prop="txpzdw" style="width: 48%">
            <el-input
              placeholder="请填写退休批准单位"
              clearable
              v-model.trim="basicInfomation.txpzdw"
            >
            </el-input>
          </el-form-item>
        </div>
