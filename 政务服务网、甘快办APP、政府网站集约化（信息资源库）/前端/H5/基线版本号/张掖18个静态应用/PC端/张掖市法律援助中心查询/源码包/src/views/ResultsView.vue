    ...
    <div class="result">
      <template>
        <table v-for="(item, index) in resultsObj.dataList" :key="index">
          <tr>
            <td class="tab_bt">机构名称</td>
            <td colspan="3">{{ item.name || "暂无数据" }}</td>
          </tr>
          <tr>
            <td class="tab_bt">负责人姓名</td>
            <td >{{ item.xm  || "暂无数据" }}</td>
            <td class="tab_bt">行政区划代码</td>
            <td >{{ item.dm  || "暂无数据" }}</td>
          </tr>
          <tr>
            <td class="tab_bt">联系电话</td>
            <td >{{ item.dh  || "暂无数据" }}</td>
            <td class="tab_bt">机构地址</td>
            <td >{{ item.dz  || "暂无数据" }}</td>
          </tr>
          <tr>
            <td class="tab_bt">机构简介</td>
