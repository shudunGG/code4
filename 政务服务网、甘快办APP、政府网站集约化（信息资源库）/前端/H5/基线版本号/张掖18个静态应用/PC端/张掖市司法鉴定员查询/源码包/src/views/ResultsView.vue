    ...
    <div class="result">
      <template>
        <table v-for="(item, index) in resultsObj.dataList" :key="index">
          ...
          <tr>
            <td class="tab_bt">执业类别</td>
            <td colspan="3">{{ item.zylb || "暂无数据" }}</td>   
             
          </tr>
          <tr>
            <td class="tab_bt">技术职称</td>
            <td>{{ item.jszc || "暂无数据" }}</td> 
            <td class="tab_bt">执业机构</td>
            <td>{{ item.zyjg || "暂无数据" }}</td>    
          </tr>
          <tr>
            <td class="tab_bt">执业证有效期</td>
            <td colspan="3">{{ item.yxq || "暂无数据" }}</td>   
          </tr>
