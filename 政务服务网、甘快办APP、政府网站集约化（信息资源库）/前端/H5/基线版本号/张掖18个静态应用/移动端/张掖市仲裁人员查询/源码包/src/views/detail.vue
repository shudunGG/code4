      ...
      <van-list
        ...
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">执业年限</div>
              <div class="list-right">{{ item.zynx || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">执业证号</div>
              <div class="list-right">{{ item.zyzh || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">执业机构</div>
              <div class="list-right">{{ item.zyjg || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">联系地址</div>
