        ...
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              ...
              <div class="list-right">{{ item.xb || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">执业类别</div>
              <div class="list-right">{{ item.zylb || "暂无数据" }}</div>
            </div>
            <div class="list">
            ...
            <div class="list">
              <div class="list-left">执业证有效期</div>
              <div class="list-right">{{ item.zyzyxq || "暂无数据" }}</div>
            </div>
          </div>
        </div>
      </van-list>
