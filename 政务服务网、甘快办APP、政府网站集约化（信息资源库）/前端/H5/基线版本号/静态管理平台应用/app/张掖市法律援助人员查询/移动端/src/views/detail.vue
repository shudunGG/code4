      ...
      >
        <div class="container-bottom">
          <div class="card-wrap" v-for="(item, index) in list" :key="index">
            ...
            <div class="list">
              <div class="list-left">职务</div>
              <div class="list-right">{{ item.zw || "暂无数据" }}</div>
            </div>
            <div class="list">
              <div class="list-left">隶属机构</div>
              <div class="list-right">{{ item.lsjg || "暂无数据" }}</div>
            </div>
            <div class="list">
            ...
            <div class="list">
              <div class="list-left">办公地址</div>
              <div class="list-right">{{ item.bgdz || "暂无数据" }}</div>
            </div>
          </div>
        </div>
      </van-list>
