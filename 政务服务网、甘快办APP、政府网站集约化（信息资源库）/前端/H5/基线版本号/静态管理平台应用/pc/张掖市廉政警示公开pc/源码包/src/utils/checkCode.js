...
function validateCode(inputCode) {
     ...
     try {
         ...
         formData.append('uuid', inputCode.uuid)
         formData.append('sandCode', inputCode.sandCode)
         // const result = await checkcode.cheackCaptcha(formData)
         ...
         //     return false
         // }
         checkcode.cheackCaptcha(formData).then((res) => {
