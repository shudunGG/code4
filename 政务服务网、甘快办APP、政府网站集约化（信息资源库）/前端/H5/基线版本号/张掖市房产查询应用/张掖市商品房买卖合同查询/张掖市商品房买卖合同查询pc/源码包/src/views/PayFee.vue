        ...
        <template>
          <table>
            ...
            <tr>
              ...
              <td>
                {{ resultData.SPFHTBH || "暂无数据" }}
              </td>
              <td class="tab_bt">合同类型</td>
              <td>
                {{ resultData.SPFHTLX || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">开发商名称</td>
              <td>
                {{ resultData.KFSMC || "暂无数据" }}
              </td>
              <td class="tab_bt">开发商信用代码</td>
              <td>{{ resultData.KFSTYXYDM || "暂无数据" }}</td>
            </tr>
            <tr>
              <td class="tab_bt">开发商联系方式</td>
              <td>
                {{ resultData.KFSLXFS || "暂无数据" }}
              </td>
              <td class="tab_bt">开发商联系地址</td>
              <td>{{ resultData.KFSLXDZ || "暂无数据" }}</td>
            </tr>
            <tr>
              <td class="tab_bt">项目名称</td>
              <td>
                {{ resultData.XMMC || "暂无数据" }}
              </td>
              <td class="tab_bt">销售许可证号</td>
              <td>
                {{ resultData.XSXKZH || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">楼幢名称</td>
              <td>
                {{ resultData.LDH || "暂无数据" }}
              </td>
              <td class="tab_bt">单元名称</td>
              <td>
                {{ resultData.DYH || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">房号</td>
              <td>
                {{ resultData.HH || "暂无数据" }}
              </td>
              <td class="tab_bt">房屋用途</td>
              <td>
                {{ resultData.FWYT || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">建筑结构</td>
              <td>
                {{ resultData.JZJG || "暂无数据" }}
              </td>
              <td class="tab_bt">朝向</td>
              <td>
                {{ resultData.CX || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">房屋户型</td>
              <td>
                {{ resultData.FWHX || "暂无数据" }}
              </td>
            ...
            <tr>
              ...
              <td class="tab_bt">成交价格</td>
              <td>
                {{ resultData.CJJG || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">付款方式</td>
              <td>
                {{ resultData.FKFS || "暂无数据" }}
              </td>
              <td class="tab_bt">共有类型</td>
              <td>
                {{ resultData.GYLX || "暂无数据" }}
              </td>
            </tr>
            <tr>
              ...
              <td class="tab_bt">物业公司</td>
              <td>
                {{ resultData.WYGS || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">物业收费标准</td>
              <td>
                {{ resultData.WYSFBZ || "暂无数据" }}
              </td>
              <td class="tab_bt">资金监管银行</td>
              <td>
                {{ resultData.ZJJGYHMC || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">资金监管账号</td>
              <td>
                {{ resultData.ZJJGYHZH || "暂无数据" }}
              </td>
              <td class="tab_bt">购房人姓名</td>
              <td>
                {{ hyposensitization(resultData.MSRLIST[0].MSRXM,"姓名") || "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">购房人证件类型</td>
              <td>
                {{ resultData.MSRLIST[0].MSRZJLX || "暂无数据" }}
              </td>
              <td class="tab_bt">购房人证件号码</td>
              <td>
                {{ hyposensitization(resultData.MSRLIST[0].MSRZJHM) || "暂无数据" }}
              </td>
            </tr>
            <tr>
