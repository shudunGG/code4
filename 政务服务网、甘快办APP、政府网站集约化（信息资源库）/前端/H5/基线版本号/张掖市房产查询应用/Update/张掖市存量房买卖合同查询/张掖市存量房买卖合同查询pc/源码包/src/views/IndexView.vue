  ...
  <div>
    ...
    <section class="query-container" v-loading="loading">
      <el-form
        ...
        label-width="120px"
      >
        <el-form-item label="合同编号" prop="clfhtbh">
          <el-input
            class="slt"
            placeholder="请输入合同编号"
            v-model="formData.clfhtbh"
            maxlength="50"
          >
          </el-input>
        </el-form-item>
        <!-- <el-form-item label="房屋坐落" prop="fwz0l">
          <el-input
            class="slt"
            placeholder="请输入房屋坐落"
        ...
        <el-form-item label="卖房人姓名" prop="sellerxm">
          <el-input
            class="slt"
            placeholder="请输入卖房人姓名（如有多个卖房人用英文逗号隔开）"
            v-model="formData.sellerxm"
            maxlength="50"
          >
          </el-input>
        </el-form-item>
        <el-form-item label="卖房人身份证号" prop="sellerzjhm">
          <el-input
            class="slt"
            placeholder="请输入卖房人身份证号（如有多个购房人用英文逗号隔开）"
            v-model="formData.sellerzjhm"
            maxlength="50"
          >
          </el-input>
        </el-form-item> -->
        <el-form-item label="购房人姓名" prop="buyerxm">
          <el-input
            readonly
            class="slt"
            placeholder="请输入购房人姓名（如有多个购房人用英文逗号隔开）"
            v-model="formData.buyerxm"
            maxlength="50"
          >
          </el-input>
        </el-form-item>
        <el-form-item label="购房人身份证号" prop="buyerzjhm">
          <el-input
            class="slt"
            placeholder="请输入购房人身份证号（如有多个购房人用英文逗号隔开）"
...
export default {
  ...
  async mounted() {
    ...
    this.formData.buyerxm = userInfo.name;
    this.formData.buyerzjhm = userInfo.card;
  },
  data() {
          ...
          const params = {
            params: sm2.encrypt(
              JSON.stringify({
                ...
                // clfhtbh: "1511230002",
                clfhtbh: this.formData.clfhtbh,
                // fwzl: "张火公路203号水勘院3号楼2层4-202室",
                // fwzl: this.formData.fwzl,
                buyerxm: userInfo.buyerxm,
                // sellerxm: this.formData.sellerxm,
                buyerzjhm: userInfo.buyerzjhm,
