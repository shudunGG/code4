        ...
        <template>
          <table>
            ...
            <tr>
              ...
              <td>
                {{ resultData.CLFHTBH || "暂无数据" }}
              </td>
              <td class="tab_bt">卖方姓名</td>
              <td>
                {{ hyposensitization(resultData.SELLERXM ,"姓名")|| "暂无数据" }}
              </td>
            </tr>
            <tr>
              <td class="tab_bt">卖方证件号码</td>
              <td>
                {{ hyposensitization(resultData.SELLERZJHM) || "暂无数据" }}
              </td>
              <td class="tab_bt">卖方联系方式</td>
              <td>{{ phone(resultData.SELLERLXFS) || "暂无数据" }}</td>
            </tr>
            <tr>
              <td class="tab_bt">卖方联系地址</td>
              <td>
