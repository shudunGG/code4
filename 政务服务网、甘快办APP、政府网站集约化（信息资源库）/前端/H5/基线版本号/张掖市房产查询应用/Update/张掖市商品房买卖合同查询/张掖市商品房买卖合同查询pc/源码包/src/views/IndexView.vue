  ...
  data() {
    ...
    return {
      ...
      formRules: {
        ...
        buyerxm: [
          { required: false, message: "购房人姓名不能为空", trigger: "blur" },
          ...
          const params = {
            params: sm2.encrypt(
              JSON.stringify({
                ...
                // clfhtbh:"1511250005",
                spfhtbh: this.formData.spfhtbh,
                // fwzl: "民主东街175-215号新世纪2号综合楼-1层15室、民主东街175-215号新世纪2号综合楼4层3-402室",
                // fwzl: this.formData.fwzl,
                // buyerxm: "金晓鹏",
                // buyerzjhm: "622223199109112318",
