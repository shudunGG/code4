      ...
      <div class="card-content">
        <div class="card">
          ...
          <div class="card-right">
            {{ dataObj.ZLFHTBH || "暂无数据" }}
          </div>
        </div>
        <div class="card">
          <div class="card-left">出租方姓名</div>
          <div class="card-right">
            {{ hyposensitization(dataObj.SELLERZJHM,'姓名') || "暂无数据" }}
          </div>
        </div>
        <div class="card">
          <div class="card-left">出租方证件号码</div>
          <div class="card-right">
            {{ hyposensitization(dataObj.SELLERZJHM) || "暂无数据" }}
          </div>
        </div>
        <div class="card">
          <div class="card-left">出租方联系方式</div>
          <div class="card-right">
            {{ phone(dataObj.SELLERLXFS) || "暂无数据" }}
          </div>
        </div>
        <div class="card">
          <div class="card-left">出租方联系地址</div>
          <div class="card-right">
        ...
        <div class="card">
          <div class="card-left">承租人姓名</div>
          <div class="card-right">
            {{ hyposensitization(dataObj.MSRLIST[0].MSRXM,'姓名') || "暂无数据" }}
          </div>
        </div>
        <div class="card">
          <div class="card-left">承租人证件类型</div>
          <div class="card-right">
            {{ dataObj.MSRLIST[0].MSRZJLX || "暂无数据" }}
          </div>
        </div>
        <div class="card">
          <div class="card-left">承租人证件号码</div>
          <div class="card-right">
