<template>
  <div class="app">
    ...
    <div class="card-warp">
      ...
      /> -->
      <div class="text-top" style="margin-top: 12px">
        <div class="left"><span style="color: #ee0a24; margin-right: 2px">*</span>承租人姓名</div>
      </div>
      <van-field
        v-model="buyerxm"
        placeholder="请输入承租人姓名（如有多个出租人用英文逗号隔开"
        clearable
        readonly
        maxlength="50"
      />
      <div class="text-top" style="margin-top: 12px">
        <div class="left"><span style="color: #ee0a24; margin-right: 2px">*</span>承租人身份证号</div>
      </div>
      <van-field
        v-model="buyerzjhm"
